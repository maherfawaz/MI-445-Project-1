...
public class WaypointMover : MonoBehaviour
{
    ...
    [Tooltip("Whether or not the waypoint mover is on and doing its movement code")]
    ...
    /// <summary>
    /// Sets the platform to be on or off depending on the value passed in.
    /// </summary>
    /// <param name="newOnValue">The new state of the platform, True for on, False for off</param>
    public void SetPlatformOnStatus(bool newOnValue)
    {
        isOn = newOnValue;
    }
